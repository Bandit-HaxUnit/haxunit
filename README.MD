...
```commandline
python3 main.py -d example.com -m extensive --use-acunetix --cloud-upload 
```
...
```commandline
python3 main.py -d example.com --use-acunetix
```
...
| katana          | Subdomain discovery             | Gather all URL's on the list of subdomains and parse the domain using unfurl                          |
